...
<!-- Layout: Cerkl Broadcast lockup top-left, AllCore Technologies logo top-right, with a horizontal divider rule below, then H1 underneath. Render as:
     <div class="hero-compact" style="justify-content: space-between;">
       ...
       <span class="wordmark-ph"><img src="../allcore-logo.png" alt="AllCore Technologies" style="height:32px"></span>
     </div>
...
**AllCore Technologies logo (right, ~32px tall):** `../allcore-logo.png`
